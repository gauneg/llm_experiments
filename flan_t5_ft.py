...
class T5FineTuner(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        optimizer = Adafactor(optimizer_grouped_parameters,eps=self.hparam.adam_epsilon,
                           lr=self.hparam.learning_rate, relative_step=False)
...
tokenizer = AutoTokenizer.from_pretrained("google/flan-t5-small",TOKENIZERS_PARALLELISM=True)
